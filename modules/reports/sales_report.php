    ...
    <div class="container">
        <aside class="sidebar">
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="sales_report.php">Sales Report</a></li>
        ...
        <main class="content">
            ...
            <div class="report-summary">
                <h2>Summary</h2>
                <p>Report Period: <?php echo date('M j, Y', strtotime($startDate)); ?> to <?php echo date('M j, Y', strtotime($endDate)); ?></p>
                    ...
                    <tbody>
                        <?php foreach ($sales as $sale): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="sale_details.php?id=<?php echo $sale['sale_id']; ?>" class="btn btn-primary">View Details</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
