        ...
        <aside class="sidebar">
            <div class="user-profile">
                <div class="user-info">
                    ...
                    <span class="role">(<?php echo isPharmacist() ? 'Pharmacist' : 'Cashier'; ?>)</span>
                </div>
            </div>

            <nav class="dashboard-nav">
                <ul>
                    <li><a href="../dashboard/<?php echo isPharmacist() ? 'pharmacist' : 'cashier'; ?>.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                    <li><a href="process_sale.php"><i class="fas fa-cash-register"></i> Process Sale</a></li>
                    <li class="active"><a href="sales_history.php"><i class="fas fa-history"></i> Sales History</a></li>
                    <?php if (isPharmacist()): ?>
