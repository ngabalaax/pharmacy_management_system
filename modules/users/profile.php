...
$success = false;
$user = [];
$profile_pic = '../../assets/images/default-profile.png'; // Default profile picture
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] === UPLOAD_ERR_OK) {
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            if (move_uploaded_file($_FILES['profile_pic']['tmp_name'], $destination)) {
                ...
                if (!empty($user['profile_pic']) && $user['profile_pic'] !== 'default-profile.png') {
    ...
    if (empty($errors)) {
        try {
            ...
            // Update profile pic path if changed
            if (isset($new_filename)) {
                $profile_pic = '../../uploads/profile_pics/' . $new_filename;
            }
...
<!-- Rest of your HTML remains the same, just update the message display section -->
...
<body>
    <div class="dashboard-container">
        ...
        if (isPharmacist()) {
            include '../pharmacist/pharmacist_sidebar.php';
        } elseif (isCashier()) {
            include '../cashier/cashier_sidebar.php';
        } elseif (isManager()) {
            include '../manager/manager_sidebar.php';
        } elseif (isStoreCoordinator()) {
            include '../store_coordinator/store_coordinator_sidebar.php';
        }
        ?>
            ...
            <div class="profile-container">
                <div class="profile-sidebar">
                    <div class="profile-upload">
                        <img src="<?php echo htmlspecialchars($profile_pic); ?>" alt="Profile Picture"
                            class="profile-picture" id="profile-preview">
                        ...
                        <div class="user-stats" style="margin-top: 1.5rem;">
                            ...
                            <?php if ($user['last_login']): ?>
                                <p><i class="fas fa-clock"></i> Last login:
                                    <?php echo date('M j, Y g:i A', strtotime($user['last_login'])); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="profile-content">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <h3
                            style="margin: 2rem 0 1rem; color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 0.5rem;">
