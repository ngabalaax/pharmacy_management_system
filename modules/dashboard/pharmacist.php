    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <nav class="dashboard-nav">
                <ul>
                    <li class="active"><a href="pharmacist.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        ...
        <main class="content">
            ...
            <div class="recent-activity">
                <div class="section-header">
                    ...
                    <a href="../sales/sales_history.php" class="view-all">View All <i class="fas fa-chevron-right"></i></a>
                </div>
