        ...
        <main class="content">
            ...
            <div class="expiry-filters">
                <a href="?filter=expired"
                    class="expiry-filter expired <?php echo $filter === 'expired' ? 'active' : ''; ?>">
                ...
                <a href="?filter=critical"
                    class="expiry-filter critical <?php echo $filter === 'critical' ? 'active' : ''; ?>">
                ...
                <a href="?filter=expiring"
                    class="expiry-filter expiring <?php echo $filter === 'expiring' ? 'active' : ''; ?>">
