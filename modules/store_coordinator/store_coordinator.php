    ...
    <div class="dashboard-container">
        ...
        <main class="content">
            <div class="dashboard-header">
                ...
                <p class="welcome-message">Welcome back, <?php echo htmlspecialchars($_SESSION['first_name']); ?>!
                    Here's your inventory overview.</p>
            </div>
            ...
            <div class="recent-activity">
                <div class="section-header">
                    ...
                    <a href="../inventory/view_drugs.php" class="view-all">View All <i
